...
try {
    ...
    $mail->Subject = '¡Nueva Compra: Logo! | ByJuanii Designs';
    $mail->Body    = '<html>
        <body>
            <center>
                <div class="form-wrapper" style="background-color:white; margin: 5% 0; width: 300px; border-radius: 25px; border: 1px solid #333333; padding: 5% 5%;">
                    ...
                    <div class="input-wrapper" style="text-align: center">
                        <h2 style="font-weight: 300;">¡Nueva Compra: <b>Logo</b>!</h2>
                        <p><b>Nombre: </b>'.$nombre.'</p>                          
                        <p><b>Email: </b>'.$email.'</p>
                        <p><b>Comentario: </b>'.$comentario.'</p>
                        <p><b>Rubro Empresarial: </b>'.$rubro.'</p> 
                        <p><b>Seleccionar Tipografía: </b>'.$tipografia.'</p> 
                        <p><b>Origen del Nombre: </b>'.$origen.'</p> 
                        <br>
                        <p><b>Precio: </b>U$S 9.99</p>
                    </div>
                </div>
            </center>
        </body>
